...
<link rel="stylesheet" href="styleConnexion.css" />
   ...
   <tbody> <!-- Corps du tableau -->
	 ...
	 for(Salle s : salles) {
		 ...
		 out.print("<tr>");
         out.print("<td><a href=\"/projet_jee/Serv?op=lienSalle&param="+s.getNom()+"\">"+s.getNom()+"</a></td>");
         out.print("<td>"+s.getVille()+"</td>");
         out.print("<td>"+s.getAdresse()+"</td>");
         out.print("<td>"+s.getCapacite()+"</td>");
         out.print("<td>"+s.getTelephone()+"</td>");
         out.print("</tr>");
