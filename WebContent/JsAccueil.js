...
Artiste.addEventListener('mouseover', function(){
	...
	genreArtiste.style.top = (Artiste.offsetTop + Artiste.offsetHeight).toString()  + 'px';
	}, false);
...
Artiste.addEventListener('mouseover', function(e) {
    ...
    while (relatedTarget != genreArtiste && relatedTarget.nodeName != 'BODY' && relatedTarget != document) {
